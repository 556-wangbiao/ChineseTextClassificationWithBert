...
def parsers():
    ...
    parser.add_argument("--save_model_best", type=str, default=os.path.join("my_model", "best_model.pth"))
    parser.add_argument("--save_model_last", type=str, default=os.path.join("my_model", "last_model.pth"))
